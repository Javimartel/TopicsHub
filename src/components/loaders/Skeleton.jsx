...
const Skeleton = () => {
    return (
        <>
            <div className="flex max-w-[30rem] min-w-[360px] gap-5 p-5 bg-white shadow-lg select-none sm:p-4 sm:h-64 rounded-2xl ">
                <div className="bg-gray-200 h-52 sm:h-full sm:w-32 rounded-xl animate-pulse">
                </div>
