...
const SendMessage = ({ theme }) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="flex items-center justify-center min-w-[300px] w-2/4 gap-2">
            <Input type="text" inputRef={inputRef} label="Message" maxLength={255} className="dark:text-white"/>
